...
def pilih():
    ...
    if zedd == '':
        print '\x1b[1;91m[!] Isi yang bener tod'
        pilih()
    else:
        if zedd == '1':
            informasi()
